  ...
  useEffect(() => {
    ...
    if (savedRoomId && socket.connected) {
      ...
      socket.emit("joinRoom", {
        roomId: savedRoomId,
        username: userObj?.username || user?.username,
        userId: userObj?._id || user?.id || user?._id,
      });
                            ...
                            style={{
                              backgroundColor:
                                activeFile?.id === file.id
                                  ...
                                  : "transparent",
                              color:
                                activeFile?.id === file.id ? c.accent : c.text,
                            }}
                          >
                            <div
            ...
            <div className="flex flex-col items-center gap-2 mt-4">
              {files.slice(0, 5).map((file) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      activeFile?.id === file.id ? c.activeTab : "transparent",
                  }}
                  title={file.name}
                >
                  <div
          ...
          <div className="border-t" style={{ borderColor: c.border }}>
            <div className="relative">
              <button
                ...
                style={{
                  backgroundColor: userMenuOpen ? c.bgTertiary : "transparent",
                }}
              >
                <div
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Zap
                          size={16}
                          style={{ color: theme === "dark" ? c.bg : "#FFFFFF" }}
                        />
                      </div>
            ...
            {activeFile && (
              <div className="flex items-center gap-2">
                ...
                <span
                  ...
                  style={{ backgroundColor: c.bgTertiary, color: c.textMuted }}
                >
                  {activeFile.language}
                </span>
              </div>
        ...
        {terminalVisible && (
          ...
          >
                ...
                {["terminal", "output", "error", "input"].map((tab) => (
                  <button
                    ...
                    style={{
                      ...
                      borderBottom:
                        terminalTab === tab ? `2px solid ${c.accent}` : "none",
                    }}
                  >
                    {tab}
                  </button>
            ...
            >
              ...
              {terminalTab === "error" && (
                <pre className="whitespace-pre-wrap" style={{ color: c.error }}>
