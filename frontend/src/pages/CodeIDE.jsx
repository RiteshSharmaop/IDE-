...
const handleDeleteFile = (fileId) => {
  ...
  const handleCloseFile = (fileId, e) => {
   ...
   const handleCopyLink = () => {
    const shareLink = `${window.location.origin}/room/${Math.random().toString(36).substr(2, 9)}`;
  ...
  return (
    <div className="flex h-screen w-full">
      <div className="flex h-screen w-[97%]" style={{ backgroundColor: c.bg, color: c.text, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
